...
class App:
    def __init__(self):
        ...
        # label
        self.label_matricula = Label(self.janela, text="Matrícula", font="Tahoma 14 bold", fg="blue")
        ...
        # label
        self.label_nome = Label(self.janela, text="Nome", font="Tahoma 14 bold", fg="blue")
        ...
        # label
        self.label_idade = Label(self.janela, text="Idade", font="Tahoma 14 bold", fg="blue")
        ...
        # label
        self.label_nota = Label(self.janela, text="Nota", font="Tahoma 14 bold", fg="blue")
